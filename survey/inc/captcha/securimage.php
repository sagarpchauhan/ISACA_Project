...
class Securimage {
   ...
   */
  var $wordlist_file = 'inc/captcha/words/words.txt';
   ...
   * @var mixed
   */
  var $gd_font_file = 'inc/captcha/gdfonts/bubblebath.gdf';
   ...
   * @var string
   */
  var $ttf_file = "inc/captcha/elephant.ttf";
   ...
   * @var string
   */
  var $multi_text_color = "#df2c00,#000000,#ec870e";
  ...
  function createCode()
  {
    ...
    if ($this->use_wordlist && is_readable(PATH.$this->wordlist_file)) {
  ...
  {
    $fp = @fopen(PATH.$this->wordlist_file, 'rb');
    if (!$fp) return false;

    $fsize = filesize(PATH.$this->wordlist_file);
